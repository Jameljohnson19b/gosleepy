    ...
    return (
        <main className="min-h-screen bg-black text-white">
            ...
            <div className="p-6 space-y-10">
                ...
                <section>
                    ...
                    <div className="bg-[#111] border border-white/5 rounded-[2rem] p-6 shadow-3xl">
                        <p className="text-gray-400 text-sm leading-relaxed mb-6">
                            This property has been indexed for high-speed roadside accessibility. Located merely {offer.distanceMiles}mi from your current position, it offers optimized ingress/egress patterns for late-arrival travelers.
                        </p>
                ...
                {/* Quick Actions */}
                <div className="grid grid-cols-2 gap-4">
                    <a href={`tel:${offer.hotelPhone || '5550123'}`} className="group flex flex-col items-center justify-center p-6 bg-[#111] rounded-3xl border border-gray-800 hover:border-[#ff10f0]/50 active:scale-95 transition-all">
                ...
                <section>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        {offer.amenities?.map((amenity, i) => (
                            <div key={i} className="flex items-center gap-3 p-4 bg-[#111] rounded-2xl border border-white/5">
                                <div className="w-2 h-2 rounded-full bg-[#ff10f0]/40" />
                                <span className="text-[10px] font-bold text-gray-400 uppercase tracking-tighter truncate">{amenity}</span>
                            </div>
                        ))}
                    </div>
                </section>
